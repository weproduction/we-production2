            ...
            <Fragment>
                <div className="block content">
                    <h2 className="title is-2 has-text-primary">
                        <Translate id="services.drone.title"/>
                    </h2>
              ...
              <div className="block content">
                <h5 className="title is-5">
                  <Translate id="services.drone.block1.title"/>
                </h5>
                <p className="is-size-6">
                  <Translate id="services.drone.block1.content"/>
                </p>
              </div>
              <div className="block content">
                <h5 className="title is-5">
                  <Translate id="services.drone.block2.title"/>
                </h5>
                <p className="is-size-6">
                  <Translate id="services.drone.block2.content"/>
                </p>
              </div>
              <div className="block content">
                <h5 className="title is-5">
                  <Translate id="services.drone.block3.title"/>
                </h5>
                <p className="is-size-6">
                  <Translate id="services.drone.block3.content"/>
                </p>
              </div>
              <div className="block content">
                <p className="is-size-6">
